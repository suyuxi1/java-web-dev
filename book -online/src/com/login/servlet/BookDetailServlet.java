...
public class BookDetailServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resq) throws ServerException, IOException, ServletException {
        //获取请求的URI，并去除空格
        ...
        for(Book book : bookList){
            if(Integer.parseInt(id) == book.getId()){
                ...
                req.getRequestDispatcher("/book_detail.jsp").forward(req, resq);
            }
